...
# VERSION & CHANGELOG
# ==========================================================
SCRIPT_VERSION = "v7.1-DEPTH-FIX"
# v7.1 : Correctifs profondeur chapitre 3 (mars 2026)
#   - Réintroduction incitation RAG ciblée pour chapitres lourds (3, 4, 6)
#   - Prompt chapitre 3 renforcé : 5 SECTIONS numérotées + "ne t'arrête pas"
#   - Seuils minimum de mots par chapitre (250 mots pour ch.3 vs 80 pour ch.1)
#   - Détection sections manquantes pour chapitre 3 (vigilance, interfaces)
#   - Suppression vérification indexation (inutile, fiable côté Prisme)
